...
const ModifyTranscriptDialog = (props) => {
  const {
    prompts,
    modifiedText,
    transcription,
    ...
    selectedTranscript,
    handleGenerateNote,
    handleSaveNewTranscription,
    handleReplaceTranscription,
    handleModifyTranscription,
    handleTranscriptDialogClose,
    isModifyTranscriptDialogOpen,
  ...
  return (
    <div>
      <Dialog
        open={isModifyTranscriptDialogOpen}
      ...
      >
        ...
        >
          ...
          <IconButton
            ...
            onClick={handleTranscriptDialogClose}
          >
                ...
                {prompts?.map((prompt, index) => (
                  ...
                  >
                    <Box
                      ...
                      onClick={(e) => {
                        if (!transcriptionModificationInProgress) {
                          handleModifyTranscription(prompt.prompt);
                        }
                        e.stopPropagation();
                      }}
                    >
        ...
        >
          ...
          >
            {modifiedText && (
              <>
                {!selectedTranscript.isOriginal && (
                  <Button
                    onClick={(e) => {
                      handleReplaceTranscription(selectedTranscript);
                      e.stopPropagation();
                    }}
                    variant="outlined"
                  >
...
export default ModifyTranscriptDialog;

      ...
      >
        ...
        <MenuItem
          onClick={(e) => {
            e.stopPropagation();
            handleClose();
            handleShareVideoInChat(selectedConversation, video);
          }}
        >
          <ListItemIcon
            style={{
      ...
      >
        ...
        <MenuItem
          onClick={(e) => {
            e.stopPropagation();
            handleClose();
            handleShareImageInChat(selectedConversation, image);
          }}
        >
          <ListItemIcon
            style={{
...
export default function MediaList(props) {
  ...
  let media;
  media = activeComponent === "Videos" ? videos : images;
  ...
  const handleShareVideoInChat = async (chat, video) => {
    toast.success("video shared");
    setIsNewMessage(true);
    socket.emit("shareExistingMediaInChat", {
      conversationId: chat._id,
      senderId: user._id,
      senderName: user.username,
      mediaFileName: video.fileName,
      mediaFilePath: video.filePath,
      type: "Video",
      transcription: video.transcription,
    });
  };
  const handleShareImageInChat = async (chat, image) => {
                ...
                <Grid item xs={12} sm={4} md={4} lg={4} xl={4} key={index}>
                  {activeComponent === "Videos" && (
                    <VideoItem
                      ...
                      handleShareVideoInChat={handleShareVideoInChat}
                    />
                  )}
                  {activeComponent === "Images" && (
                    <ImageItem
                      ...
                      handleOpenVideoInNewTab={handleOpenVideoInNewTab}
                      handleFileDownload={handleFileDownload}
                      handleShareImageInChat={handleShareImageInChat}
                      selectedConversation={selectedConversation}
                    />
                  )}
                </Grid>

    ...
    if (selectedFiles.length > 0) {
          ...
          const uploadFile = async () => {
            try {
              ...
              const response = await axios.post(
                `${process.env.REACT_APP_API}/api/v1/conversation/share-videos`,
                formData,
                config
              );
      ...
      Promise.all(uploadPromises)
        .then(() => {
          ...
          // handleDocumentUploadSuccess();s
          toast.success("videos Shared");
          resetUploader();
        })
        .catch((error) => {
          console.error(error);
            ...
            >
              {dragging ? (
                ...
                >
                  ...
                  />
                  Click or drag and drop Videos here
                </div>
              )}
            </div>
            <input
